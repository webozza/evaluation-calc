...
<?php if ( isset($_POST['time_estimate']) == 1 ) {
        ...
        // Add the Meter
        $pdf->Image( $theMeter, 165, 70, 32, 0, 'PNG');

        // The Heading
        $pdf->SetFont('helvetica','B',16);
        $pdf->Cell(176, 80, 'MONITORING AND EVALUATION PLAN REQUIREMENTS', 0, 0, 'L');
        $pdf->Ln(0.1);
        ...
        // $timeInfo = str_replace('hours', 'hours', $timeInfo);
